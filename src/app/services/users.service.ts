...
import { AccountType } from '../helpers/classes/classes';
...
export class UsersService {
  ...
  users$: BehaviorSubject<any> = new BehaviorSubject([
    ...
    },
    {
      ...
      "emails": [
        {
          "address": "demo.seller.a@gmail.com",
          "verified": true
        }
      ],
      password: 'demo.seller.a',
      "info": {
        "firstName": "Seller A",
        "lastName": "Demo",
        "birthDate": "04/12/2000",
    ...
    },
    {
      ...
      "emails": [
        {
          "address": "demo.seller.b@gmail.com",
          "verified": true
        }
      ],
      password: 'demo.seller.b',
      "info": {
        "firstName": "Seller A",
        "lastName": "Demo",
        "birthDate": "04/12/2000",
    ...
    },
    {
      ...
      "emails": [
        {
          "address": "demo.seller.c@gmail.com",
          "verified": true
        }
      ],
      password: 'demo.seller.c',
      "info": {
        "firstName": "Seller C",
        "lastName": "Demo",
        "birthDate": "04/12/2000",
  ...
  getSellers(): Observable<any> {
    return this.users$.pipe(
      map(users => users.filter((user: any) => user.accountType == AccountType.SELLER))
    );
  }
